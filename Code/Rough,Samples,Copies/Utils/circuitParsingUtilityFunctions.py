...
# class Circuit:
#     """Circuit object to save the circuit info"""
#     def __init__(self):
#         self.reset()
...
#         """Reset parser state"""
#         #print("\n**A**\n")
#         #print("\nRunning the call for resetting the parser state...\n")
...
#         self.faultModel = ""
#         self.isFaulty = False
#         self.faultPosition = None
        
#     def setFaultPosition(self, wire = None, level = None, ):
        
#         if self.faultModel == "SMGF" :
#             self.faultPosition["wire"] = 
...
class RealFileParser:
    ...
    def parse_file(self, filepath: str) -> Dict[str, Any]:
        ...
        """
        #print("\n**B**\n")
        #print("\nRunning the call for parsing the file from given path...\n")
        
        #print("Reset the parser state\n")
        self.reset()
        ...
        for line in lines:
            ...
            #print("Create and Return the circuit dictionary\n")
    ...
    def _parse_gate(self, gate_line: str) -> Dict[str, Any]:
        ...
        """
        #print("\n**C**\n")
        #print("\nRunning the call for parsing the gate...\n")
    ...
    def _create_circuit_dict(self) -> Dict[str, Any]:
        ...
        """
        #print("\n**D**\n")
        #print("\nRunning the call for creating the circuit dictionary...\n")
    ...
    def to_internal_circuit(self, circuit_dict: Dict[str, Any]) -> List[Tuple]:
        ...
        """
        #print("\n**E**\n")
        #print("\nRunning the call for converting the parsed circuit dictionary to internal format...\n")
...
def parse_real_file(filepath: str) -> Dict[str, Any]:
    ...
    """
    #print("\n**F**\n")
    #print("\nRunning the call for Parsing the file...\n")
    
    #print("create a parser object\n")
    parser = RealFileParser()
    #print("Use the parse_file method of the parser object for Parsing the file\n")
...
def parse_real_directory(directory: str, pattern: str = "*.real") -> List[Dict[str, Any]]:
    ...
    """
    #print("\n**G**\n")
    #print("\nRunning the call for parsing the directory...\n")
...
def real_circuits_to_dataframe(circuits: List[Dict[str, Any]]) -> pd.DataFrame:
    ...
    """
    #print("\n**H**\n")
    #print("\nConverting circuits to DataFrame...\n")
...
def save_to_json(circuits: List[Dict[str, Any]], output_path: str):
    ...
    """
    #print("\n**I**\n")
    #print("\nRunning the call for saving circuits to JSON...\n")
...
def create_circuit_info_sheet(circuits: List[Dict[str, Any]], output_path: str):
    ...
    """
    #print("\n**J**\n")
    #print("\nRunning the call for creating circuit Info Sheet...\n")
    
    #print("Convert real circuits to dataframe...\n")
...
# # create a representation plot for the circuit using the images

# def circuit_representation_as_plot(circuit):
